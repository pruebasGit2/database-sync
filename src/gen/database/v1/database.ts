...
/**
 * @generated from protobuf message database.DownloadScriptsRequest
 */
...
class DownloadScriptsRequest$Type extends MessageType<DownloadScriptsRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DownloadScriptsRequest): DownloadScriptsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
...
/**
 * @generated MessageType for protobuf message database.DownloadScriptsRequest
 */
export const DownloadScriptsRequest = new DownloadScriptsRequest$Type();
/**
...
export const Database = new ServiceType("database.Database", [
    ...
    { name: "DownloadScripts", options: {}, I: DownloadScriptsRequest, O: Empty }
]);
