type DbScriptProps = {
    database: string,
    scripts: string[],
    onClick?: (db: string, scripts: string[]) => void
}
...
export const DbScript = ({
    ...
    return (
        <div
            className="w-auto h-6 rounded bg-primary border-foreground hover:border-primary hover:bg-foreground"
            onClick={() => onClick && onClick(database, scripts)}
        >
